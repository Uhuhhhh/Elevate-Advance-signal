...
function getTradeTime(tf){
    ...
    // Entry starts at the next minute
    ...
    // Expiry after selected timeframe
    expiry.setMinutes(expiry.getMinutes() + Number(tf));
    ...
    return {
        ...
        // Exact timestamps for result checking
...
entryTimestamp: tradeTime.entryTimestamp,

expiryTimestamp: tradeTime.expiryTimestamp,
